...
def BBP_MAP_not_layerwise_2(nets_list, model_meta_data, layer_type, net_dataidx_map, 
    ...
    matched_weights = []
    for layer_index in range(1, n_layers):
        layer_hungarian_weights, assignment, L_next = layer_wise_group_descent_2_all_param(
             batch_weights=batch_weights, 
             layer_index=layer_index,
             sigma0_layers=sigma0, 
             sigma_layers=sigma, 
...
if __name__ == "__main__":
    ...
    if args.comm_type == "fedavg":
        ...
        save_weights(global_weights_fedavg, "FedAvg_comm_not_layerwise_2_all_param")
        ...
        global_weights_fedma = fedma_comm_not_layerwise_2(comm_init_batch_weights,
                                 ...
                                 device=device)
        logger.info("FedMA with communication finished")
        save_weights(global_weights_fedma, "FedMA_comm_not_layerwise_2_all_param")
